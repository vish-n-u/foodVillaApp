...
const RestaurantCard = ({cloudinaryImageId:img,name,avgRating:rating,deliveryTime,cuisines,costForTwoString:cost,id}) =>{
    return (
        ...
        <div className="aspect-square w-80 m-4 mt-0 bg-fuchsia-50   overflow-hidden p-3  hover:transition   hover:shadow-sm hover:shadow-slate-800" key="restaurantCard">
            <Link to={"/menucard/"+id }>
