...
const PreviousOrders = () => {
  ...
  return showLoadingScreen ? (
    ...
    >
      <div
        className={`h-[63%] w-full py-4 my-2  border-2 ${
          pageColour == "white"
        ...
        >
          {allPrevOrders.map((rs) => {
            ...
            return (
              <div
                key={rs._id}
                className={`my-2 rounded-lg flex container ${
              ...
              >
                      ...
                      if (vals.id == key) {
                        ...
                        return (
                          <div key={key + index}>
                            ...
                            <span
                              key={key}
                              className={`ml-3 mt-1 font-semibold text-sm ${
                                pageColour == "white"
                                  ? "text-black"
                                  : "text-white"
                              }`}
                    ...
                    <button
                      onClick={() => {
                        if (Object.keys(cartItems).length == 0)
                          handleClick(rs._id, Dispatch, allPrevOrders, allMenu);
                        else {
                ...
                {showCartItemsMessage && (
                  <div
                    id="repeatOrder"
                    className=" ml-0  flex  transition-all   items-end text-center scroll-smooth justify-end py-4 my-4 border-blue-800"
                  >
