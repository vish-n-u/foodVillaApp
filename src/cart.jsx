...
console.log("checking id",eachItemPrice,id)
    ...
    return(
    <div  key={id} className={`box-border text-[13.5px] font-semibold ${pageColour=="white"?"text-slate-700":"text-slate-300"}   flex items-center align-middle  justify-between px-2 mt-2 hover:shadow-xl w-full`} > 
